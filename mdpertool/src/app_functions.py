...
from PySide2.QtWidgets import QFileDialog, QDialog, QTableWidgetItem, QProgressDialog, QTabBar, QVBoxLayout, \
    ...
    def save_as_png_Pymol(self, created_pymol_widget, width_horizontalSlider, height_horizontalSlider,
        ...
        if filename == "":
            Message_Boxes.Warning_message(self, 'png save failed!', "No file name selected.",
                                          ui_main.Style.MessageBox_stylesheet)
            return
        ...
        try:
            ...
            Message_Boxes.Critical_message(self, 'png save failed!', str(save_err), ui_main.Style.MessageBox_stylesheet)
...
class Functions(QMainWindow):
    ...
    def plot_networks(self):
        ...
        if len(clean_graph_list) > 0:
            ...
            # --> Dissipation Widget
            dissipation_curve_widget = ui_main.WidgetPlot(self)
            ...
            if os.path.exists(possible_path.strip()) and possible_path.split('.')[-1] == 'csv':
                ...
                row, col, Response_Count = ui_main.getResponseTimeGraph(possible_path)
            ...
            Message_Boxes.Information_message(self, "DONE !", all_path_string, ui_main.Style.MessageBox_stylesheet)
                ...
                if isinstance(graph_i, nx.classes.digraph.DiGraph):
                    if len(self.initial_network.nodes()) > 0:
                        ...
                        for j in clean_log_list:
                            # if j != '':
                            all = all + '\n' + j
                        Message_Boxes.Information_message(self, "DONE !", all, ui_main.Style.MessageBox_stylesheet)
    ...
    def browse_responseTimeFile(self):
        ...
        try:
            ...
            Message_Boxes.Warning_message(self, "Fatal Error!", str(exp), ui_main.Style.MessageBox_stylesheet)
    ...
    def browse_bound_form_pdbFile(self):
        ...
        try:
            ...
            if d.filename[2] == 'pdb':
                ...
                Message_Boxes.Critical_message(self, "Error", "this is not a pdb file", ui_main.Style.MessageBox_stylesheet)
        ...
        try:
            ...
            if os.path.exists(path):
                ...
                answer = Message_Boxes.Information_message(self, "Test PDB File Not Found",
                                                           ...
                                                           "specified location.", ui_main.Style.MessageBox_stylesheet)
