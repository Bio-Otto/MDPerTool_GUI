...
log_path = os.path.join('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output', file_name)
...
fixed_pdb_name = fix_pdb('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/Download/2J0W_E~2.PDB', fixed_pdb_out_path='C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output', logger_object=log_obj)
...
app.PDBFile.writeModel(modeller.topology, positions, open('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output/minimized.pdb', 'w'), keepIds=True)
...
simulation.reporters.append(DCDReporter('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output/output.dcd', 100))
...
last_pdb = app.PDBFile.writeFile(modeller.topology, lastpositions, open('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output/last.pdb', 'w'), keepIds=True)


state = simulation.context.getState(getPositions=True, getVelocities=True)

with open('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output/system.xml', 'w') as f:
    system_xml = mm.XmlSerializer.serialize(system)
    f.write(system_xml)

with open('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output/integrator.xml', 'w') as f:
    integrator_xml = mm.XmlSerializer.serialize(integrator)
    f.write(integrator_xml)

with open('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output/state.xml', 'w') as f:
...
OUTPUT_DIRECTORY = Path('C:/Users/IBRAHI~1.OZD/ONEDRI~1/MASAST~1/MDPERT~1/MDPERT~1/output')
