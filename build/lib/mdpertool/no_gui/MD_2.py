...
class Reference_MD_Engine:
    ...
    def __init__(self, pdb_path, state_file='state.xml', protein_ff=None, water_ff=None, time_step=None,
        ...
        self.system = forcefield.createSystem(topology, nonbondedMethod=CutoffNonPeriodic, nonbondedCutoff=self.nonbondedCutoff, removeCMMotion=False)
        ...
        if self.write_to_dcd:
            ...
            simulation.reporters.append(app.DCDReporter(DCD_file_path, self.dcd_write_period, enforcePeriodicBox=False))
        ...
        if self.write_to_xtc:
            ...
            simulation.reporters.append(app.XTCReporter(XTC_file_path, self.xtc_write_period, enforcePeriodicBox=False))
